    ...
    public partial class Profit_Loss_Calculations : Form
    {
       ...
       public static DataTable refkey_dt = new DataTable();
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    //save to database
                    cmd.Parameters.Clear();
                    string qry = "insert into profit_loss_tb (sale_rev_gross_sale,dpdw1,sale_rev_cash_sale,sale_rev_non_cash_sale,cash_sale_b_percent,non_cash_sale_c_percent,gross_sale_dollar_d,cog_dollar_ff,cog_dollar_h,dollar_l,dpdw3,x_percent,o_percent,xx_percent,q_percent,dollar_r,v_percent,new_dollar_t,dollar_tt,dollar_v,dollar_z,dollar_vv) VALUES (@sale_rev_gross_sale,@dpdw1,@sale_rev_cash_sale,@sale_rev_non_cash_sale,@cash_sale_b_percent,@non_cash_sale_c_percent,@gross_sale_dollar_d,@cog_dollar_ff,@cog_dollar_h,@dollar_l,@dpdw3,@x_percent,@o_percent,@xx_percent,@q_percent,@dollar_r,@v_percent,@new_dollar_t,@dollar_tt,@dollar_v,@dollar_z,@dollar_vv) ";
                    cmd.CommandText = qry;
                    cmd.Connection = db_conect;
                    ...
                    cmd.Parameters.AddWithValue("@dpdw1", comboBox1.Text);
                    ...
                    cmd.Parameters.AddWithValue("@dpdw3", comboBox3.Text);
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (label16.Text == "--g-" || label17.Text == "--g-")
            {
        ...
        public void opexs()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    dolz = dolz.Replace("(", "-");
                    dolz = dolz.Replace(")", str2);
                    double.TryParse(dolz, out dollar_z);
                    if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && label17.Text != "---" && label40.Text != "---")
                    {
                    ...
                    if (percent_ww_negative == false && dollar_vv_negative == false && percent_w_negative == false && dollar_v_negative == false && dollar_tt_uu_percent_negative == false && percent_u_negative == false && dollar_t_negative == false)
                    {
                        ...
                        dolv = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:C0}", double.Parse(dolv));
                        perw = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:P2}", double.Parse(perw));
                        label70.Text = dolv + "   |   " + perw;
                        //label71.Text = "W% : " + percent_w.ToString();
                        //label80.Text = "$VV : " + dollar_vv.ToString();
                        //label81.Text = "WW% : " + ww_percent.ToString();

                        string dolvv = dollar_vv.ToString();
                        string perww = ww_percent.ToString();
                        dolvv = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:C0}", double.Parse(dolvv));
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (s_percent_negative == false && percent_o_negative == false && percent_q_negative == false && dollar_r_negative == false)
                    {
                        ...
                        string dolr = dollar_r.ToString();
                        string pers = percent_s.ToString();
                        pers = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:P1}", double.Parse(pers));
                        dolr = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:C0}", double.Parse(dolr));

                        label40.Text = dolr + "   |   " + pers;
                    }
                    else
                    {
                        ////label12.Text = "K% : " + k_percent + "%";
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in defined_data.Rows)
            {
                ...
                label79.Text = string.Format(CultureInfo.CreateSpecificCulture("en-US"), "{0:C0}", double.Parse(label79.Text));
            }
